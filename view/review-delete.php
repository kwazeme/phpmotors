...
<head>
    ...
    if (isset($revInfo["invMake"]) && isset($revInfo["invModel"])) {
        # code...
        echo "Delete your review for $revInfo[invMake]'s $revInfo[invModel]";
    } elseif (isset($invMake) && isset($invModel)) {
        # code...
        echo "Delete your review for $invMake $invModel";
    }
    ?> | PHP Motors</title>
</head>
<body>
...
<main class="content clearfix formpage">
    ...
    if (isset($revInfo['invMake']) && isset($revInfo['invModel'])) {
        # code...
        echo "Delete your review for $revInfo[invMake] $revInfo[invModel]";
    } elseif (isset($invMake) && isset($invModel)) {
        # code...
        echo "Delete your review for $invMake $invModel";
    }
    ?></h1>  
      ...
      ?> <h2>Reviewed on <?php if(isset($revInfo['reviewDate'])) { echo "$revDate";} else {
        ...
        <p class="error"> &#9888;&#65039;<br>Deletes cannot be undone. Are you sure you want to delete your review?</p>
        <form id="review-form" action="/phpmotors/reviews/" method="post">
            ...
            <textarea rows='4' id='reviewText' name='reviewText' readonly><?php if(isset($revInfo['reviewText'])) { echo "$revInfo[reviewText]"; } elseif (isset($reviewText)) {echo "$reviewText]";}?></textarea>
            </p>
            <p>
            <input type="submit" name="submit" id="deletebtn" value="Delete Review">
